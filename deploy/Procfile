...
#     echo '{ "name": "word-guesser", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/word-guesser/word-guesser
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/word-guesser/word-guesser production -p $PORT
